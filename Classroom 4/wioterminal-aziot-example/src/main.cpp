...
void loop()
{
    ...
    spr.drawNumber(temp,0,0); //display value
    spr.pushSprite(50,95); //push to LCD
    ...
    spr.setTextSize(3);
    spr.setTextColor(TFT_BLACK);
    spr.drawNumber(humi,0,0); //display value
    spr.pushSprite(30,190); //push to LCD
    spr.deleteSprite(); //clear buffer
    ...
    spr.setTextSize(3);
    spr.setTextColor(TFT_BLACK);
    spr.drawNumber(light,0,0); //display value
    spr.pushSprite(200,190); //push to LCD
    spr.deleteSprite(); //clear buffer
    ...
    spr.setTextSize(3);
    spr.setTextColor(TFT_BLACK);
    spr.drawNumber(soil,0,0); //display value
    spr.pushSprite(200,95); //push to LCD
    spr.deleteSprite(); //clear buffer
